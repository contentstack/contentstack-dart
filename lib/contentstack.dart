...
class Entry {
  ...
  fetch() {
    ...
    this._queryParameters['environment'] = _config._environment;
    Uri uri = Uri.https(_config._endpoint().toString(), '/v3/content_types/$_contentTypeUid/entries/$_uid', this._queryParameters);
    return HTTPConnection(_config, uri).getData();
  }
  ...
  find(Map<String, String> queryPrams) async {
    ...
    Uri uri = Uri.https(_config._endpoint(), '/v3/content_types/$_contentTypeUid/entries', this._queryParameters);
